...
*   [`drylikov/html-tag-names`](https://github.com/drylikov/html-tag-names)
    — list of HTML tag names
*   [`drylikov/html-element-attributes`](https://github.com/drylikov/html-element-attributes)
    — map of HTML attributes
*   [`drylikov/html-void-elements`](https://github.com/drylikov/html-void-elements)
    — list of void HTML tag-names
*   [`drylikov/property-information`](https://github.com/drylikov/property-information)
    — info on HTML, SVG, etc properties
*   [`drylikov/web-namespaces`](https://github.com/drylikov/web-namespaces)
...
[build-badge]: https://github.com/drylikov/doctype/workflows/main/badge.svg

[build]: https://github.com/drylikov/doctype/actions

[coverage-badge]: https://img.shields.io/codecov/c/github/drylikov/doctype.svg

[coverage]: https://codecov.io/github/drylikov/doctype
